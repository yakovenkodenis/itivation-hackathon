...
jQuery(document).ready(function($) {
 ...
 $(document).ready(function() {
  var weeks, days, text_weeks, text_days;
  $('#countdown').countdown('2016/11/05', function(event) {
    ...
    if (locale === 'en') {
      ...
      // if (['2', '3', '4'].indexOf(weeks) >= 0) {
      //   text_weeks = 'недели';
      // }

      if (
        ['2', '3', '4'].filter(
          function(e) { return weeks.indexOf(e) !== -1; }
        ).length > 0
      ) {
        text_weeks = 'недели';
      }
      ...
      // if (['2', '3', '4'].indexOf(days) >= 0) {
      //   text_days = 'дня';
      // }

      if (
        ['2', '3', '4'].filter(
          function(e) { return days.indexOf(e) !== 01; }
        ).length > 0
      ) {
        text_days = 'дня';
      }

      $(this).html(event.strftime('%w ' + text_weeks + ' %d ' + text_days + '<br /> %H:%M:%S'));
    }
  });
