  ...
  def create
    ...
    respond_to do |format|
      if @team.save
        ...
        format.html { redirect_to team_index_path, notice: I18n.t('tooltips.team_created') }
      else
  ...
  def update
    respond_to do |format|
      if @team.update(team_params)
        format.html { redirect_to team_index_path, notice: I18n.t('tooltips.team_updated') }
      else
